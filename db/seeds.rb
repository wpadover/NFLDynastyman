...
FantasyTeam.create(owner_name: 'Marc Adelberg', team_name: 'Team Adelberg', abbreviation: 'ADEL')
FantasyTeam.create(owner_name: 'Nicholas Nottebohm', team_name: 'Team Nottebohm', abbreviation: 'NOTT')
FantasyTeam.create(owner_name: 'Rich Clark', team_name: 'Tickle Me Elmo', abbreviation: 'CLAR')
FantasyTeam.create(owner_name: 'Spiro Floratos', team_name: 'Got Hates Jags', abbreviation: 'JAGS')
